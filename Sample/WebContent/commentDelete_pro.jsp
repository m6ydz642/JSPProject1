...
cdto.setId(userid); // setter에게 넘어온 userid 값 세팅 해줌
// 세팅안했다가 계속 null값 나와서 삽질함 ㅡ.ㅡ 


String DBName = cdto.getId(); // 댓글작성자를 게터로 부터 가져옴


int check = cdao.deleteComment(commentNum, userid);  // 코맨트에서 넘어온 번호와 userid, 인자 2개  전달
