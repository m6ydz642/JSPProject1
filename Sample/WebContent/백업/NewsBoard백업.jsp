    ...
    <div data-layout="ec12 fo10 fo-n2">
      <div class="MOD_BLOGROLL1_Single">
        <header>
						...
						%>
						<a href="#" class="MOD_BLOGROLL1_SingleTitle" data-theme="_ts2">
						<h2><%=bean.getSubject()%></h2></a>
				<div class="MOD_BLOG1_Meta">
					<p class="MOD_BLOG1_Author"><%=bean.getUsername()%>
					</p>
					<p>
						<b>Published</b> <span class="MOD_BLOG1_Date"><%=new SimpleDateFormat("yyyy.MM.dd").format(bean.getDate())%></span>
						| <b>Categories</b> <span class="MOD_BLOG1_Cats"><a
