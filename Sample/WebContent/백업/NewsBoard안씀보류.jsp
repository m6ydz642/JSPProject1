...
NewsBoardBean bean2 = boardDAO.getNewsBoard(contentnum); // DB번호에서 num값 얻어옴 (글번호)
System.out.println("넘어온 게시글 num값 " + contentnum);
	...
	<div data-layout="_r">
		...
		<div data-layout="ec12 fo10 fo-n2">
			...
			<div class="MOD_BLOGROLL1_Single">
				...
				<a href="NewsBoard.jsp?num=<%=bean.getNum()%>" class="MOD_BLOGROLL1_SingleTitle"
					data-theme="_ts2">
...
<%-- (<%=cdto.getId() %>) --%>		
 	<img src="img/del.png" class="del"
		onclick="location.href='NewsCommentDelete_pro.jsp?NewscommentNum=<%=cdto.getNum()%>&pageNum=<%=pageNum%>&num=<%=dto.getNum()%>'">
