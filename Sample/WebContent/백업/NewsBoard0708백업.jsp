...
String userid = (String) session.getAttribute("userid"); // 사용자 아이디값
	// num  pageNum 가져오기 (위에서 이미 가져와서 안함)
...
// 			if (DBName.equals(userid) || cdto.getId().equals(userid)) { // 이거 잠시 보류
...
%>	
	...
	<div class="MOD_BLOGROLL1_Pagination">
        <ul>
          <li><a href="javascript:return false;" onclick="location.href='NewsBoard.jsp?num=<%=bean.getNum()-1%>&pageNum=<%=bean.getNum()-1%>'">&xlArr; Previous</a></li> 
          <li><a href="#">2</a></li>
          <li><a href="#">3</a></li>
          <li><a href="#">4</a></li>
